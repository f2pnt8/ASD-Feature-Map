...
//				'zoom' => '4',
			...
			array (
				...
				'type'          => 'select' ,
				'instructions'  => 'Select an icon for the place on the map. Select "Custom Icon" to upload a file.' ,
				'choices'       => array (
					'custom'              => 'Custom Icon ...' ,
					'marker'              => 'Marker' ,
					'airplane'            => 'Airplane' ,
					...
					'embassy'             => 'Embassy' ,
					'emo-happy'           => 'Emo Happy' ,
					'emo-thumbsup'        => 'Emo Thumbs up' ,
					'emo-unhappy'         => 'Emo Unhappy' ,
					'emo-wink'            => 'Emo Wink' ,
					'emo-wink2'           => 'Emo Wink' ,
					'fancy-pop'           => 'Fancy Pop' ,
					'fast-food'           => 'Fast Food' ,
